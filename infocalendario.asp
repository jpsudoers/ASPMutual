                               ...
                               (
                                      {
                                           ...
                                           elements:
'Empresa;programa;EmpMan;Compromiso;txtNum;tabProgId;NParticipantes;Valor;ValorTotal;TipoEmpresa;Costo;ConOtic;COfran;NReg_Fran;proPert',										
										   dataType: 'json',
                                           success: function (data, status)
                                           {
											   if(typeof(data.error) != 'undefined')
...
<div id="header">
   ...
   WHILE NOT DATOS.EOF
		...
		%>
		<li><a href="#" accesskey="6" title="" class="selItem">Información</a></li>
        <%end if				
	 DATOS.MoveNext
   WEND
   end if
