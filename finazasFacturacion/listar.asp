...
sql = sql&" inner join AUTORIZACION on AUTORIZACION.ID_AUTORIZACION=HISTORICO_CURSOS.ID_AUTORIZACION "
sql = sql&" inner join INSTRUCTOR_RELATOR on INSTRUCTOR_RELATOR.ID_INSTRUCTOR=HISTORICO_CURSOS.RELATOR "
sql = sql&"where HISTORICO_CURSOS.ESTADO=0 and AUTORIZACION.FACTURADO=1 order by PROGRAMA.ID_PROGRAMA asc"
