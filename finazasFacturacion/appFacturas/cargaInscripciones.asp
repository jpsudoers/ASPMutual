...
sql = "select EMPRESAS.RUT,UPPER (EMPRESAS.R_SOCIAL) as R_SOCIAL,"&_
            ...
            " where AUTORIZACION.ESTADO=0 AND AUTORIZACION.FACTURADO=1 AND YEAR(PROGRAMA.FECHA_INICIO_) in (2007,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022) /*AND AUTORIZACION.FECHA_rev_cierre<=convert(datetime, '23-06-2016 18:00:00')*/ "& Request("id_curso")&_
			" /* AND PROGRAMA.FECHA_INICIO_<convert(date, '01-02-2018')*/ "&_
			" /*and AUTORIZACION.ID_AUTORIZACION NOT IN (50923,50875,51050,51026,51216)*/"&_
            " ORDER BY /*AUTORIZACION.CON_FRANQUICIA,AUTORIZACION.CON_OTIC,*/AUTORIZACION.FECHA_REV_CIERRE asc"
