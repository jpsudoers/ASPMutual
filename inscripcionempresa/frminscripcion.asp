...
%>
 <form name="frminscripcion" id="frminscripcion" action="inscripcionempresa/modificar.asp" method="post">
...
%> <form name="frminscripcion" id="frminscripcion" action="inscripcionempresa/insertar.asp" method="post">
    <table cellspacing="0" cellpadding="1" border=0>
     <tr>
       <td>Rut Empresa :</td>
       ...
       <td>&nbsp;</td>
       <td>Raz&oacute;n Social :</td>
         <td colspan="3"><label id="txtRsoc" name="txtRsoc"></label></td>
     </tr>
      <tr>
       <td width="155">C&oacute;digo Autorizaci&oacute;n:</td>
       <td width="200"><select id="autorizacion" name="autorizacion" tabindex="1" onchange="cargaDatos(this.value);grilla(0);">
       </select></td>
       <td width="20" ><input type="hidden" id="Empresa" name="Empresa" value="" /></td>
       <td width="150">&nbsp;</td>
       <td width="172">&nbsp;</td>
        <td width="20" >&nbsp;</td>
       <td width="150">&nbsp;</td>
