...
if(vTipo="0")then
sql = "select dbo.MayMinTexto (R_SOCIAL) as R_SOCIAL,ID_EMPRESA as usuario,TIPO_CONTACTO,ACTIVA,"
sql = sql&"blq=ISNULL((select count(*) from EMPRESAS_BLOQUEOS e where e.ID_EMPRESA=empresas.ID_EMPRESA and e.ESTADO=0),0) from EMPRESAS "
...
sql = sql&"ID_INSTRUCTOR as relUser from USUARIOS "
