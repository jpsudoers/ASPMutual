...
<div id="content">
	...
	<div id="colTwo">
       ...
       <div class="suggestionsBox" id="suggestions" style="display: none;position:absolute;z-index:100px;left:600px">
            ...
            <div class="suggestionList" id="autoSuggestionsList">
              &nbsp;
                        ...
                        <tr>
                            <td><label id="txtRsocCam" name="txtRsocCam">&nbsp;</label></td>
                            <td><label id="txtRsoc" name="txtRsoc"></label></td>
   					   </tr>
                       <tr>
                            <td colspan="2"><input type="hidden" id="Empresa" name="Empresa"/>&nbsp;</td>
   					   </tr>
					</table>
              </form> 
				</div>	
