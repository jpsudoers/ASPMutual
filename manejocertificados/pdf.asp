...
vtrab_empresas=""
if(Request("trab_empresas")<>"")then
   vtrab_empresas=" and HISTORICO_CURSOS.ID_TRABAJADOR in ("&Request("trab_empresas")&")"
end if

dim tot
tot="select COUNT(distinct ID_EMPRESA) as total from HISTORICO_CURSOS "
tot=tot&" where HISTORICO_CURSOS.ID_PROGRAMA="&Request("prog")&relator&vtrab_empresas
'tot=tot&" and HISTORICO_CURSOS.RELATOR="&Request("relator")

set Total = conn.execute (tot)

dim trabEmpQuery
trabEmpQuery="select distinct ID_EMPRESA from HISTORICO_CURSOS where HISTORICO_CURSOS.ID_PROGRAMA="&Request("prog")&relator&vtrab_empresas
...
function TablaParticipantes(theDoc)
	...
	sql3 = sql3&" where HISTORICO_CURSOS.ID_PROGRAMA="&Request("prog")&" and HISTORICO_CURSOS.ID_EMPRESA="&empresa_id&relator&vtrab_empresas
