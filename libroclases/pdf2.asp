...
if(idMutual="40")then
	...
	theDoc.AddHtml ("<b>HOJA DE REGISTRO DE ASISTENCIA MES DE "&mes&"</b>"&"mmm")
	...
	while not rs3.eof
		...
		if(fila=10 or fila=20 or fila=30)then
...
function Tabla7(theDoc)
	...
	while not rs3.eof
		...
		if(participante=10 or participante=20 or participante=30)then
			theDoc.Rect = "30 50 760 570"
		    theDoc.Page = theDoc.AddPage()
			theDoc.FontSize = 12
