...
cabeceraPagina.SetFile Server.MapPath("../images/fondoCertCodelco.jpg")
...
if(Request("empresa")<>"0")then
	...
	histTrab=histTrab&"Day(P.FECHA_TERMINO) as 'Dia',"
...
function Tabla(theDoc)
	...
	theDoc.Rect = "2 2 790 340"
	theDoc.Color = "148 54 52"
	theDoc.FontSize = 16
	...
	theTable.NextCell
	theDoc.HPos = 0
	theTable.AddText rsHistTrab("Mes")	
	theTable.NextCell
	theDoc.HPos = 0	
