...
sql = sql&"(CASE WHEN AUTORIZACION.CON_OTIC=1 AND AUTORIZACION.TIPO_DOC=4 then '0' "
sql = sql&" WHEN AUTORIZACION.CON_OTIC=0 AND AUTORIZACION.TIPO_DOC=4 then '0' "
sql = sql&" WHEN AUTORIZACION.CON_OTIC=1 AND AUTORIZACION.TIPO_DOC<>4 then '1' "
sql = sql&" WHEN AUTORIZACION.CON_OTIC=0 AND AUTORIZACION.TIPO_DOC<>4 then '1' END) as 'ConOticyCarta' "
