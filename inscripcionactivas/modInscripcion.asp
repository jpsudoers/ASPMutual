...
vTpReferencia = Request("TpReferencia")
vtxtReferencia = Request("txtReferencia")
...
UpAutoriza = UpAutoriza&"VALOR_OC='"&vvalortotal&"', VALOR_CURSO='"&vValor&"', CON_OTIC='"&vconotic&"', " 
