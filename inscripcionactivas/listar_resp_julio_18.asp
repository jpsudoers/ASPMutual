...
WHILE NOT DATOS.EOF
	if(fila>=inicio AND fila<(limite*pagina))then
		...
		Response.Write("<cell><![CDATA[<span class=""ui-state-valid"" ><a href=""#"" title=""Unir o Separar Inscripciones"" class=""ui-icon ui-icon-newwin"" name=""aContrato"" onclick=""unirsep("&DATOS("ID_AUTORIZACION")&")""></a></span>]]></cell>"&chr(13))
