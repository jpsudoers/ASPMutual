...
query= query&"TRABAJADOR.NOM_TRAB,TRABAJADOR.APATERTRAB,TRABAJADOR.AMATERTRAB,NACIONALIDAD,ID_EXTRANJERO,CORREO,TRABAJADOR.EMAIL "
query= query&" from TRABAJADOR "
query= query&" where TRABAJADOR.id_trabajador='"&Request("trabId")&"'"

set rsEmp = conn.execute (query)

if not rsEmp.eof and not rsEmp.bof then 
%>
 <form name="frmTrabajador" id="frmTrabajador" action="inscripcionactivas/tab_modificar.asp" method="post">
 ...
 %>
    ...
    <tr>
        ...
        <td><input id="txtMail" name="txtMail" type="text" tabindex="13" maxlength="50" size="30" value="<%=rsEmp("CORREO")%>"/></td>
    </tr>
     <tr>
       <td>Email  : </td>
       <td><input id="txtEmailTrab" name="txtEmailTrab" type="text" maxlength="50" size="30" value="<%=rsEmp("EMAIL")%>"/></td>
     </tr>  
     <tr>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
...
%><form name="frmTrabajador" id="frmTrabajador" action="inscripcionactivas/tab_insertar.asp" method="post">
 <table cellspacing="0" cellpadding="1" border=0>
     <tr>
     ...
     <tr>
       ...
       <input id="txtTrabProg" name="txtTrabProg" type="hidden" value="<%=Request("histProgId")%>"/>
       <input id="TrabFecha" name="TrabFecha" type="hidden" value="<%=Request("tabPart")%>"/>
       <input id="TrabHistId" name="TrabHistId" type="hidden" value="<%=Request("histId")%>"/>
       <input id="autoIdTxt" name="autoIdTxt" type="hidden" value="<%=Request("autoId")%>"/>
    ...
    <tr>
        <td>Tel&eacute;fono :</td>
        <td><input id="txtMail" name="txtMail" type="text" tabindex="13" maxlength="50" size="30"></td>
    </tr>
     <tr>
       <td>Email  : </td>
       <td><input id="txtEmailTrab" name="txtEmailTrab" type="text" maxlength="50" size="30"/></td>
     </tr> 
     <tr>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
