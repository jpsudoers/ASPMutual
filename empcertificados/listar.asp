...
emp=" and H.ID_EMPRESA='"&Session("usuario")&"'"

if(Session("usuario")="17765")then
	emp=" and C.ID_MUTUAL in (2108,2106,2110,2109,2111,2107) "
end if

sql = "select E.ID_EMPRESA,T.RUT,dbo.MayMinTexto(T.NOMBRES) as NOMBRES,C.NOMBRE_CURSO, "
...
sql = sql&"END) as color,C.ID_MUTUAL "  
...
sql = sql&" where H.EVALUACION='Aprobado' and H.ESTADO=0 "&trab&emp&" ORDER BY "&columna&" "&orden
