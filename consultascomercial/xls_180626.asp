...
qsMan="select PROGRAMA.ID_PROGRAMA ,CURRICULO.CODIGO ,PROGRAMA.FECHA_INICIO_, "&_
		...
		" where HISTORICO_CURSOS.ID_PROGRAMA=PROGRAMA.ID_PROGRAMA) as inscritos,  "&_
		"(select COUNT(*) from HISTORICO_CURSOS  "&_
		...
		" and HISTORICO_CURSOS.ESTADO=0) as Aprobados,  "&_
		...
		" and HISTORICO_CURSOS.ESTADO=0) as Reprobados,  "&_
		...
		" (dbo.Estado_evaluacion(bq.estado_eva_cdn)) as 'EC' ,   "&_
