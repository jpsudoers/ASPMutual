...
<form name="frmEmpresa" id="frmEmpresa" action="solicitud/insertar.asp" method="post">
    ...
    <tr>
        ...
        <td><input id="txtRsoc" name="txtRsoc" type="text" tabindex="2" maxlength="50" size="40"/></td>
        <td>&nbsp;</td>
        <td>Giro :</td>
        <td><input id="txtGiro" name="txtGiro" type="text" tabindex="3"  size="40"  maxlength="40"/></td>
   	</tr>
	<tr>
        <td>Direcci&oacute;n :</td>
        <td colspan="1"><input id="txtDir" name="txtDir" type="text" tabindex="4" maxlength="50" size="40"/></td>
        <td>&nbsp;</td>
        <td>Comuna :</td>
	...
	<tr>
       ...
       <td></td>
       <td>Estable:</td>
       <td><input type="radio" name="Contratista" id="Contratista" value="0" checked/>Si
 		   <input type="radio" name="Contratista" id="Contratista" value="1"/>No</td>
    </tr>
    <tr>
    	<td>Mutual :</td>
