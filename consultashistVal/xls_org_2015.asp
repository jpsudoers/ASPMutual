...
Response.AddHeader "content-disposition", "inline; filename=Historica_Valorizada_"&fecha&".xls"
	...
	qsHc=qsHc&"END) as 'Tipo Documento',AUTORIZACION.ORDEN_COMPRA, " 
	...
	qsHc=qsHc&"AUTORIZACION.FECHA_REV_CIERRE from HISTORICO_CURSOS " 
    ...
    <tr>
      ...
      <td width="150" align="center"><b><font size="2">Orden de Compra</font></b></td>      
    ...
    <tr>
        ...
        <td align="center"><b><font size="2"><%="$"&replace(FormatNumber(rsHc("VALOR_CURSO"),0),",",".")%></font></b></td>	        <td><b><font size="2"><%=rsHc("Tipo Documento")%></font></b></td>                                      
        ...
        <td><b><font size="2">=HIPERVINCULO("http://norte.otecmutual.cl/ordenes/<%=rsHc("OC")%>";"Ver")</font></b></td>
