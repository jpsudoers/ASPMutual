...
$(document).ready(function(){
	...
	function VerInforme()
	{
		//window.open("infoVencimientos/pdf.asp?dias="+$('#dias').val())
		documento("infoVencimientos/pdf.asp?dias="+$('#dias').val());
	}
...
<div id="content">
	...
	<div id="colTwo">
		<div class="bg2">
        <h2><em style="text-transform: capitalize;">Informe</em><em> de </em><em style="text-transform: capitalize;">Vencimiento</em></h2>
        <br />
       <div>
			...
			<div id="buscarContent" style="border:1px solid #000099;display:block" >
                    ...
                    <table width="620" border="0" align="center" cellpadding="1" cellspacing="1">
						...
						<tr>
					        ...
					        <td colspan="2">  
                                 <select id="dias" name="dias" tabindex="3">
                                 <OPTION VALUE="0">Todos</OPTION>
                                 <OPTION VALUE="15">Entre 1 a 15 D&iacute;as</OPTION>
                                 <OPTION VALUE="30">Entre 16 a 30 D&iacute;as</OPTION>
                                 <OPTION VALUE="45">Sobre 30 D&iacute;as</OPTION>
                                 </select>
                            </td>
