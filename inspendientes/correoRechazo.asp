...
vid=Request("idRechPreins")

dim upPreins
upPreins="UPDATE preinscripciones set estado=0, situacion=2, situacion_fecha=GETDATE (), "
upPreins=upPreins&"situacion_encargado='"&Session("usuarioMutual")&"', "
upPreins=upPreins&"situacion_razon='"&Request("razonRech")&"' where id_preinscripcion="&vid
...
texto_fichero = Replace(texto_fichero,"<!--#razon-->",Request("razonRech"))
'response.End()
...
.Subject = "Solicitud de Inscripción a Curso - Rechazada"
