...
columna = "bloque_programacion.ID_BLOQUE"
...
sql = "SELECT TRABAJADOR.RUT,TRABAJADOR.NOMBRES FROM HISTORICO_CURSOS  "
...
sql = sql&" where HISTORICO_CURSOS.ID_BLOQUE='"&request("bloId")&"'"
