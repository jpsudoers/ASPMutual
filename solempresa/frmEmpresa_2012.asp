...
<table cellspacing="0" cellpadding="1" border=0>
	...
	<tr>
        ...
        <td><input id="txtRsoc" name="txtRsoc" readonly="readonly" type="text" tabindex="2" maxlength="50" value="<%=rsEmp("r_social")%>" size="30"/></td>
        <td></td>
    	<td>Giro:</td>
        <td colspan="4"><input id="txtGiro" name="txtGiro" readonly="readonly" type="text" tabindex="3" size="86" value="<%=rsEmp("giro")%>"/></td>
    </tr>
	<tr>
        <td>Direcci&oacute;n :</td>
        <td><input id="txtDir" name="txtDir" readonly="readonly" type="text" tabindex="4" maxlength="50" value="<%=rsEmp("direccion")%>" size="30"/></td>
        <td></td>
        <td>Comuna :</td>
	...
	<tr>
    	<td>Mutual :</td>
        <td><select id="txtMut" name="txtMut" tabindex="9" disabled="disabled"></select><input id="txtIdMut" name="txtIdMut" type="hidden" value="<%=rsEmp("mutual")%>"/></td>
        <td></td>
        <td>Otic :</td>
        <td colspan="4"><select id="OTIC" name="OTIC" tabindex="10" disabled="disabled" style="width:45em;"></select><input id="txtIdOtic" name="txtIdOtic" type="hidden" value="<%=rsEmp("ID_OTIC")%>"/></td>

    </tr>
        <tr>
    	<td><input id="tipoContacto" name="tipoContacto" type="hidden" value="<%=rsEmp("TIPO_CONTACTO")%>"/></td>
        <td>&nbsp;</td>
        <td></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <tr>
     ...
     <tr>
        <td>Email :</td>
        <td><input id="txtMail" name="txtMail" type="text" readonly="readonly" tabindex="13" maxlength="50" value="<%=rsEmp("email")%>"  size="30"/></td>
        <td>&nbsp;</td>
    ...
    <tr>
        <td>Email :</td>
        <td><input id="txtMailConta" name="txtMailConta" readonly="readonly" type="text" tabindex="18" maxlength="50" size="30" value="<%=rsEmp("EMAIL_CONTA")%>"/></td>
        <td>&nbsp;</td>
          <td>T&eacute;lefono :</td>
    ...
    <tr>
     ...
     <tr>
        <td colspan="4"><input type="checkbox" name="rechazar" id="rechazar" onclick="estado_solicitud();" tabindex="21"/>Rechazar Solicitud de Nueva Empresa</td>
    </tr>
    <tr>
        <td><input id="rechazo" name="rechazo" type="hidden" value="0"/></td>
        <td>&nbsp;</td>
    </tr>
</table>
</form> 
