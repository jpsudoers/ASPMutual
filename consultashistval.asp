...
$(document).ready(function(){
	...
	function VerInforme()
	{
			...
			//else
				window.open('consultashistVal/xls.asp?mes='+$("#SelMes").val()+'&ano='+$("#selAno").val()+'&insc='+$("#selIns").val(),'Informe')
	}
...
<div id="header">
	...
	sql = "select PERMISO1,PERMISO2,PERMISO3,PERMISO4,PERMISO6,PERMISO12 from USUARIOS "
...
<div id="content">
	...
	<div id="colTwo">
		<div class="bg2">
    	<h2><em style="text-transform: capitalize;">Historica Valorizada</em></h2>
        <br />
        <div>
