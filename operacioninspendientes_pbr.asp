...
$(document).ready(function(){					
	...
	$("#dialog").dialog({
	  ...
	  {prog:id_prog,id:id_preinscripcion,con_otic:$('#ConOtic').val(),con_fran:$('#Confran').val(),reg_sence:$('#Reg_Fran').val()},
							   function(f){
									$('#cursos').html(f);
									tableToGrid("#mytable"); 
...
<div id="sendConf" title="Enviando">
     <p align="center"><label id="sendMsn" name="sendMsn">Espere Mientras se envia Confirmación</label></br></br><img src="images/loadfbk.gif"/></p>
</div>
