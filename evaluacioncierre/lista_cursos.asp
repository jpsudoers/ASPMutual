...
sql = sql&" CASE WHEN CURRICULO.CODIGO ='5-2-A09' THEN '1' WHEN CURRICULO.ID_MUTUAL=2363 THEN '1' ELSE (case when GETDATE()>=DATEADD(hour, 12, PROGRAMA.FECHA_TERMINO) then '1' else '0' end) END as estadoEval, "
...
WHILE NOT DATOS.EOF
	if(fila>=inicio AND fila<(limite*pagina))then
		...
		if(DATOS("estadoEval")="1" or DATOS("ID_PROGRAMA")="12162" or DATOS("ID_PROGRAMA")="12167")then 
				if((vtipouser=1 and DATOS("act_relator")="0") or (vusr="143" and DATOS("act_relator")="0") or (vusr="8" and DATOS("act_relator")="0") or (vusr="36" and DATOS("act_relator")="0") or (vusr="108" and DATOS("act_relator")="0") or (vusr="72" and DATOS("act_relator")="0") or (vusr="172" and DATOS("act_relator")="0")  or (vusr="1249" and DATOS("act_relator")="0") or (vusr="1238" and DATOS("act_relator")="0") or (vusr="1237" and DATOS("act_relator")="0") or (vusr="32" and DATOS("act_relator")="0") or (vusr="1251" and DATOS("act_relator")="0") or (vusr="1284" and DATOS("act_relator")="0") or (vusr="1244" and DATOS("act_relator")="0") or (vusr="1295" and DATOS("act_relator")="0") or (vusr="1303" and DATOS("act_relator")="0") or (vusr="1317" and DATOS("act_relator")="0") or (vusr="1322" and DATOS("act_relator")="0"))then
