...
tot=tot&" where HISTORICO_CURSOS.ID_PROGRAMA="&Request("prog")&relator
'tot=tot&" and HISTORICO_CURSOS.RELATOR="&Request("relator")

set Total = conn.execute (tot)

set rsEmp = conn.execute ("select distinct ID_EMPRESA from HISTORICO_CURSOS where HISTORICO_CURSOS.ID_PROGRAMA="&Request("prog")&relator)
...
function Tabla2(theDoc)
	...
	sql2 = sql2&" CURRICULO.NOMBRE_CURSO as nombre_curso, "
	...
	theTable.NextCell
	theDoc.HPos = 0
	theTable.AddText rs2("nombre_curso")
...
function TablaParticipantes(theDoc)
	...
	sql3 = "select TRABAJADOR.RUT,TRABAJADOR.NOMBRES,HISTORICO_CURSOS.ASISTENCIA, "
	sql3 = sql3&" HISTORICO_CURSOS.CALIFICACION "
	...
	sql3 = sql3&" where HISTORICO_CURSOS.ID_PROGRAMA="&Request("prog")&" and HISTORICO_CURSOS.ID_EMPRESA="&empresa_id&trabajador&relator
