   ...
   <table cellspacing="0" cellpadding="1" border=0>
    ...
    <tr>
     ...
     <tr>
       ...
       <tr>
       <td>Valor :</td>
       <td><input id="txtValor" name="txtValor" type="text" tabindex="11" maxlength="20" value="<%=rsEmp("VALOR")%>" size="20"  onKeyPress="return acceptNum(event)"/></td>
     </tr>
      <tr>
       <td>Cupos :</td>
       ...
       <td></td>
       <td>Inscritos :</td>
       <td><label id="txtInscritos" name="txtInscritos"><%=rsEmp("INSCRITOS")%></label></td>
       <td></td>
       <td>Vacantes :</td>
...
%> <form name="frmProgramacion" id="frmProgramacion" action="../Copia de programacion/programacion/insertar.asp" method="post">
   <table cellspacing="0" cellpadding="1" border=0>
     ...
     <tr>
       ...
       <tr>
       <td>Valor :</td>
       <td><input id="txtValor" name="txtValor" type="text" tabindex="11" maxlength="20" size="20" onKeyPress="return acceptNum(event)"/></td>
     </tr>
      <tr>
       <td>Cupos :</td>
