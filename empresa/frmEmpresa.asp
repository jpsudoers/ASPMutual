...
<table cellspacing="0" cellpadding="1" border=0>
    ...
    <tr>
          ...
          <td  style="vertical-align: top!important;">
            ...
            <td colspan="2" style="vertical-align: top!important;"><label>OC</label><input type="checkbox" name="cond_oc" id="cond_oc" value="1"  <%=vOC%>   tabindex="24"/></td>     
     ...
     <tr>
        <td colspan="8">&nbsp;<input id="contactoIgual" name="contactoIgual" type="hidden" value="<%=rsEmp("TIPO_CONTACTO")%>"/></td>
    </tr>
</table>
</form> 
<%
...
%><form name="frmEmpresa" id="frmEmpresa" action="empresa/insertar.asp" method="post">
    ...
    <tr>
          ...
          <td  style="vertical-align: top!important;">
            ...
            <td colspan="2" style="vertical-align: top!important;"><label>OC</label><input type="checkbox" name="cond_oc" id="cond_oc" value="1"  tabindex="24"/></td>     
