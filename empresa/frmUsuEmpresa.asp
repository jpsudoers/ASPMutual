...
id_mutual = Request("id_mutual")


query="select TRABAJADOR.ID_TRABAJADOR,TRABAJADOR.RUT,TRABAJADOR.NOMBRES,TRABAJADOR.CARGO_EMPRESA,TRABAJADOR.ESCOLARIDAD,"
query= query&"TRABAJADOR.NOM_TRAB,TRABAJADOR.APATERTRAB,TRABAJADOR.AMATERTRAB,NACIONALIDAD,ID_EXTRANJERO, GERENCIA,NSAP,correo,TRABAJADOR.EMAIL"
...
<%if id_mutual = "57" then %> 
     <tr>
       <td>Gerencia : </td>
       <td><input name="txtGerencia" id="txtGerencia" type="text" value="<%=rsEmp("GERENCIA")%>" /></td>
     </tr>
    <tr>
       <td>Nº Sap : </td>
       <td><input name="txtNSap" id="txtNSap" type="text" value="<%=rsEmp("NSAP")%>" /></td>
     </tr>     
...
<% end if' curso 57%>     
    ...
    <tr>
        ...
        <td><input id="txtMail" name="txtMail" type="text" maxlength="30" size="30" value="<%=rsEmp("correo")%>"/></td>
    </tr>
     <tr>
       <td>Email  : </td>
     ...
     <tr>
       <td><input id="txtTrabID" name="txtTrabID" type="hidden" value="<%=rsEmp("ID_TRABAJADOR")%>"/></td>
       <td>&nbsp;</td>
     </tr>
   </table>
</form> 
...
<%if id_mutual = "57" then %> 
     ...
     <tr>
       <td>Gerencia : </td>
       <td><input name="txtGerencia" id="txtGerencia" type="text" /></td>
     </tr>
    <tr>
       <td>Nº Sap : </td>
       <td><input name="txtNSap" id="txtNSap" type="text" /></td>
     </tr> 
		<!--select id="escolaridadTrab" name="escolaridadTrab" tabindex="27"></select>
       ...
       <input type="hidden" id="insTbjCurso" name="insTbjCurso" value="1"/>       
...
<% end if' curso 57%>  
    <tr>
        <td>Tel&eacute;fono :</td>
        <td><input id="txtMail" name="txtMail" type="text" maxlength="30" size="30"/></td>
    </tr> 
     <tr>
       <td>Email  : </td>
