...
%>
 <form name="frmMutual" id="frmMutual" action="mutuales/modificar.asp" method="post">
<table cellspacing="0" cellpadding="1" border=0>
	...
	<tr>
        ...
        <td><input id="txtDir" name="txtDir" type="text" tabindex="5" maxlength="50" value="<%=rsEmp("direccion")%>" size="30"/></td>
        <td></td>
        <td>Comuna :</td>
	...
	<tr>
        ...
        <td><input id="txtFon" name="txtFon" type="text" tabindex="8" size="20" maxlength="20"  value="<%=rsEmp("fono")%>" onKeyPress=""/></td>
        <td></td>
        <td>Fax :</td>
        <td><input id="txtFax" name="txtFax" type="text" tabindex="9" maxlength="20" value="<%=rsEmp("fax")%>"  size="20" onKeyPress=""/></td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
        <td>&nbsp;</td>
...
%><form name="frmMutual" id="frmMutual" action="mutuales/insertar.asp" method="post">
	<table cellspacing="0" cellpadding="1" border=0 >
	<tr>
    	<td width="102">Rut :</td>
	...
	<tr>
        <td>Direcci&oacute;n :</td>
        <td><input id="txtDir" name="txtDir" type="text" tabindex="5" maxlength="50" value="" size="30"/></td>
        <td></td>
        <td>Comuna :</td>
