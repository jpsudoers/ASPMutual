...
sql = "select preinscripciones.id_preinscripcion as preinscripcion, "
sql = sql&"CURRICULO.CODIGO as codigo,dbo.MayMinTexto (CURRICULO.NOMBRE_CURSO) as curso, "
...
sql = sql&" where preinscripciones.estado=1 and preinscripciones.id_empresa='"&Session("usuario")&"'"
