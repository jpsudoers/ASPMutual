...
sql = "select (CASE WHEN trabajador.NACIONALIDAD=0 then trabajador.RUT WHEN trabajador.NACIONALIDAD=1 then trabajador.ID_EXTRANJERO END) as RUT,TRABAJADOR.NOMBRES,TRABAJADOR.CARGO_EMPRESA,TRABAJADOR.ESCOLARIDAD,PREINSCRIPCION_TRABAJADOR.franquicia " 
...
WHILE NOT DATOS.EOF
		...
		Response.Write("<cell><![CDATA["&DATOS("franquicia")&"]]></cell>"&chr(13))
