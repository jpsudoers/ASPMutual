				...
				if($.trim($('#txtFTermino').val()) != ""){
					...
					if(fecha_ini <= fecha_fin){
						if ($("input[@name='optVer']:checked").val()=="1")	
							...
							window.open("manualesexistencias/xls.asp?f_ini="+$('#txtFInicio').val()+"&f_fin="+$('#txtFTermino').val(),'Informe')
					}else{
...
<div id="content">
	...
	<div id="colTwo">
		<div class="bg2">
    	<h2><em style="text-transform: capitalize;">Informe</em><b> de </b><em style="text-transform: capitalize;">Existencias</em></h2>
        <br />
        <div>
