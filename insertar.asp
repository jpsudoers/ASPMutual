...
dim query
query = "insert into EMPRESAS (RUT,R_SOCIAL ,GIRO ,DIRECCION,COMUNA,CIUDAD ,FONO ,FAX ,MUTUAL, ESTADO "
query = query&",NOMBRES, EMAIL "
query = query&",CARGO) values('"&vrut&"','"&vrSocial&"','"&vgiro&"','"&vdir&"','"&vcom&"','"&vciu&"','"&vfon&"','"&vfax&"', "
query = query&"'"&vmut&"',1,'"&vnomb&"','"&vmail&"','"&vcargo&"') "
