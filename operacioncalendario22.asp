...
'Empresa;programa;EmpMan;Compromiso;txtNum;tabProgId;NParticipantes;Valor;ValorTotal;TipoEmpresa;Costo;ConOtic;COfran;NReg_Fran',										
   ...
   //open: function(event, ui) { $(".ui-dialog-titlebar-close").hide(); },
			buttons: {
				'Guardar': function() {
					$('.ui-dialog-buttonpane button:contains(Cancelar)').attr('disabled', true);
		...
		//$('.dialog').dialogButtons('Guardar', 'disabled');
					//$(this).dialog('close');
					//$(".ui-dialog-button-Guardar").attr("disabled", "disabled");
					//$('.ui-dialog-buttonpane button:contains(Guardar)').attr('disabled', false);
