...
<table cellspacing="3" cellpadding="1" border=0 width="960">
    ...
    <tr>
     <td colspan="8"><center><h3><em style="text-transform: capitalize;">Contacto de Coordinacion de Cursos</em></h3></center></td>
   	</tr>
    <tr>
   	   <td colspan="8">&nbsp;</td>
    </tr>
    <tr>
       ...
       <td><%=rsEmp("FONO_CONTACTO")%></td>
    </tr>
    <tr>
    	<td>Cargo :</td>
        <td colspan="7"><%=rsEmp("cargo")%></td>
    </tr>
     <tr>
    	<td colspan="8">&nbsp;</td>
    </tr>
     <tr>
    	<td colspan="8"><center><h3><em style="text-transform: capitalize;">Contacto de Contabilidad</em></h3></center></td>
   	</tr>
     <tr>
    	<td colspan="8">&nbsp;</td>
    </tr>
     <tr>
        <td>Nombre :</td>
        <td><%=rsEmp("NOMBRE_CONTA")%></td>
        <td>&nbsp;</td>
        <td>Email :</td>
        <td><%=rsEmp("EMAIL_CONTA")%></td>
        <td>&nbsp;</td>
        <td>T&eacute;lefono :</td>
        <td><%=rsEmp("FONO_CONTABILIDAD")%></td>
    </tr>
    <tr>
     <td>Cargo :</td>
     <td colspan="7"><%=rsEmp("CARGO_CONTA")%></td>
    </tr>
</table>
</form> 