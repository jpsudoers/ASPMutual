...
query="select dbo.MayMinTexto(CURRICULO.NOMBRE_CURSO) as NOMBRE_CURSO,CURRICULO.SENCE,CURRICULO.CODIGO,CURRICULO.VALOR, "
...
if(rsEmp("FECHA_INICIO_")<>rsEmp("FECHA_TERMINO"))then
msnDet=rsEmp("NOMBRE_CURSO")&" de los dias "&mid(rsEmp("FECHA_INICIO_"),1,2)&" de "&mes(mid(rsEmp("FECHA_INICIO_"),4,2)-1)&" y el "&mid(rsEmp("FECHA_TERMINO"),1,2)&" de "&mes(mid(rsEmp("FECHA_TERMINO"),4,2)-1)
else
msnDet=rsEmp("NOMBRE_CURSO")&" del dia "&mid(rsEmp("FECHA_INICIO_"),1,2)
end if
%>
 <form name="frmProgEmp" id="frmProgEmp" action="emp_programacion/insertar.asp" method="post">
   <table cellspacing="0" cellpadding="1" border=0>
     ...
     <tr>
       ...
       <td width="20"></td>
       <td width="145"></td>
       <td width="100"><input type="hidden" id="COfran" name="COfran"/></td>       
     </tr>
     <tr>
 ...
 <tr>
     ...
     <tr>
      ...
      <td><input id="datosfran" name="datosfran" type="hidden"/>
       ...
       <input type="text" id="detMsn" name="detMsn" value="<%=msnDet%>"/>
