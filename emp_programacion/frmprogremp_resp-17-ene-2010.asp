...
query="select CURRICULO.NOMBRE_CURSO,CURRICULO.CODIGO,CURRICULO.VALOR, "
 ...
 <form name="frmProgEmp" id="frmProgEmp" action="emp_programacion/insertar.asp" method="post">
   <table cellspacing="0" cellpadding="1" border=0>
     ...
     <tr>
       ...
       <td width="20">&nbsp;</td>
       <td width="145">&nbsp;</td>
       <td width="100"><input type="hidden" id="COfran" name="COfran" value="0"/></td>
     </tr>
     <tr>
       <td colspan="2">Utiliza Franquicia Sence? :&nbsp;
       	   <input type="radio" name="COfranS" id="COfranS1" value="1" onclick="$('#COfran').val(this.value);MuestraFilas(1);"/>Si
           <input type="radio" name="COfranS" id="COfranS0" value="0" onclick="$('#COfran').val(this.value);MuestraFilas(0);" checked="checked"/>No</td>
