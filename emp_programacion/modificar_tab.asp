...
vGerenciatrab = trim(Request("txtGerencia"))
vNSaptrab = trim(Request("txtNSap"))
...
query = query&"AMATERTRAB=dbo.MayMinTexto('"&vamatertrab&"'), GERENCIA='"&vGerenciatrab&"', NSAP='"&vNSaptrab&"', CORREO='"&VCORREO&"',EMAIL="&emailTrab&" WHERE ID_TRABAJADOR = '"&vtrabid&"'"
