...
<div width="200"><table id="list2"></table> 
   ...
   <table cellspacing="0" cellpadding="1" border=0>   
     ...
     <tr>
	  ...
	  <td colspan="4"><font size="-2" color="#FF0000"><i><strong><u>Datos Transferencias:</u></strong> A nombre de Mutual de Seguridad Capacitación S.A. - Rut 76.410.180-4 <br/> N° Cuenta Corriente 576026-7 del Banco Santander / enviar notificación a adiaz@mutualcapacitacion.cl</i></font></td>      
     </tr>
   </table>
   <br />
