...
sql = sql&" TRABAJADOR.NOM_TRAB,TRABAJADOR.APATERTRAB,TRABAJADOR.AMATERTRAB,TRABAJADOR.GERENCIA,TRABAJADOR.NSAP,TRABAJADOR.CORREO,TRABAJADOR.EMAIL "
...
WHILE NOT DATOS.EOF
		...
		Response.Write("<GERENCIA>"&DATOS("GERENCIA")&"</GERENCIA>"&chr(13))
		Response.Write("<NSAP>"&DATOS("NSAP")&"</NSAP>"&chr(13))
