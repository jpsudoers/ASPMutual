 ...
 <form name="frmProgEmp" id="frmProgEmp" action="emp_programacion/insertar.asp" method="post">
   <table cellspacing="0" cellpadding="1" border=0>
     ...
     <tr>
       ...
       <input type="hidden" id="id_curso" name="id_curso" value="<%=rs("ID_MUTUAL")%>"/></td>
       <td>Nombre Curso :</td>
       <td colspan="4"><%=rsEmp("NOMBRE_CURSO")%><%if(rsEmp("ID_MUTUAL")="39" or rsEmp("ID_MUTUAL")="40")then%>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">Pertenece a proyecto:</font>&nbsp;<input type="radio" name="proPert" id="proPert1" value="1"/>GPO1<input type="radio" name="proPert" id="proPert0" value="2"/>OLAP<%end if%></td>
     </tr>
     <tr>
