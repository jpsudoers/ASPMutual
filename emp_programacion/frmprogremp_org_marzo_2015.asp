...
<%end if%></td>
     ...
     <tr>
       <td colspan="8">Lugar de Ejecución : <%=rsEmp("sede")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Horario: 08:30 a 13:00 y de 14:30 a 18:00&nbsp;<%if (rsEmp("CODIGO")="12.37.8599-88" or rsEmp("CODIGO")="12.37.8329-61") then%> ambos días<%end if%></td>
     </tr>      
     <tr>
...
<div width="200"><table id="list2"></table> 
   ...
   <table cellspacing="0" cellpadding="1" border=0>   
     ...
     <tr>
	  ...
	  <td colspan="4"><font size="-2" color="#FF0000"><i><strong><u>Datos Transferencias:</u></strong> A nombre de Mutual de Seguridad Capacitación S.A. - Rut 76.410.180-4 <br/> N° Cuenta Corriente 576026-7 del Banco Santander / enviar notificación a gtoledo@mutualasesorias.cl y vlachica@mutualasesorias.cl</i></font></td>      
     </tr>
   </table>
   <br />
