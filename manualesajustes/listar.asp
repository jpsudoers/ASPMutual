...
sql = "select M.ID_MOVIMIENTO,CONVERT(VARCHAR(10),M.FECHA, 105) as FECHA,TM.NOMBRE_MOV as TIPO_MOVIMIENTO,"
...
sql = sql&" where M.MODULO=3 AND M.ESTADO=1 "
...
WHILE NOT DATOS.EOF
	if(fila>=inicio AND fila<(limite*pagina))then
		...
		Response.Write("<cell><![CDATA[<span class=""ui-state-valid"" ><a href=""#"" title=""Ver Registro"" class=""ui-icon ui-icon-document"" name=""aContrato"" onclick=""Ver("&DATOS("ID_MOVIMIENTO")&")""></a></span>]]></cell>"&chr(13))		
