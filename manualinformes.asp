...
$(document).ready(function(){
	...
	function VerInforme()
	{
			if ($("input[@name='optVer']:checked").val()=="1")	
				...
				window.open("manualesinforme/xls.asp?tipo="+$('#Tipo_Mov').val(),'Informe')
	}
...
<div id="content">
	...
	<div id="colTwo">
		<div class="bg2">
    	<h2><em style="text-transform: capitalize;">Informe</em><b> de </b><em style="text-transform: capitalize;">Movimientos</em></h2>
        <br />
        <div>
		...
		<div id="buscarContent" style="border:1px solid #000099;display:block" >
                    ...
                    <table width="620" border="0" align="center" cellpadding="1" cellspacing="1">
						...
						<tr>
					        ...
					        <td>  
                                 <select id="Tipo_Mov" name="Tipo_Mov" tabindex="3" style="width:8em;">
